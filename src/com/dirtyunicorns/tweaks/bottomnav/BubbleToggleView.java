...
import com.dirtyunicorns.tweaks.bottomnav.ViewUtils;
...
public class BubbleToggleView extends RelativeLayout {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        int layoutPadding = (int) context.getResources().getDimension(R.dimen.default_layout_padding);
        ...
        if (attrs != null) {
            ...
            try {
                ...
                layoutPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_corvus_layout_padding, layoutPadding);
        ...
        bubbleToggleItem.setLayoutPadding(layoutPadding);
